...
def create_printing_serie
  ...
  energy_card = Dir.glob("assets/card_energy.png")
  ...
  energy_card_group = energy_card * CARDS_PER_PAGE
  ...
  energy_filename = "assets/energy_all_page.pdf"
  create_page_with_convert(energy_card_group, energy_filename)
...
def merge_series
  ...
  recto_files = "assets/energy_all_page.pdf"
  ...
  FileUtils.mkdir_p('energy_serie')
  ...
  serie_filename = "energy_serie/serie_1.pdf"
  ...
  puts "📂 Fichiers générés dans: energy_serie/"
